...
const BulletListBlock = ({ block, onChange, onKeyDown, readOnly, autoFocus, cursorPosition }) => {
  ...
  return (
    <div className="flex items-start gap-2">
      <span className="text-slate-500 dark:text-slate-400 leading-relaxed select-none pt-0.5">•</span>
      <div
        ref={ref}
